...
class RectGetter extends StatefulWidget {
  ...
  static RenderBox getRectFromKey(GlobalKey<_RectGetterState> globalKey) {
    RenderBox object = globalKey?.currentContext?.findRenderObject();
//    var translation = object?.getTransformTo(null)?.getTranslation();
//    var size = object?.paintBounds?.size;
return object;
//
