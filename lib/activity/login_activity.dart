...
import 'package:kfc_flutter/activity/psd_login_activity.dart';
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => PsdLoginActivity()),
                );
              },
              child: Container(
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.only(left: 25, right: 20, top: 15),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: <Widget>[Text("温馨提示:未注册的用户，初次登录的时候将完成注册")],
                  ),
                )
              ],
            ),
